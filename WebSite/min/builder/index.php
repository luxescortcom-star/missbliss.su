...
<?php if ($symlinkOption): ?>
    <div class=topNote><b>Note:</b> It looks like you're running Minify in a user
...
<p class=topWarning id=jsDidntLoad><b>Uh Oh.</b> Minify was unable to
...
<p class=topNote><b>Note:</b> <code><?php echo
...
<p id=minRewriteFailed class="hide"><b>Note:</b> Your webserver does not seem to
...
<h3>Debug Mode</h3>
<p>When /min/config.php has <code>$min_allowDebugFlag = <b>true</b>;</code>
...
(function () {
    ...
    $(function () {
        ...
        var msg = '<\p class=topWarning><\b>Warning:<\/b> ';
        ...
        $.get(url, function (ocStatus) {
            $.get(url + '&hello=1', function (ocHello) {
                if (ocHello != 'World!') {
                    ...
                    if (ocStatus == '1')
                        $(document.body).prepend('<\p class=topNote><\b>Note:</\b> The option '
