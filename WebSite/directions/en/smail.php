...
if(trim($name) == 'Name') {
   ...
   echo '<div class="error_message">Please, in the Name field - write only your name, write your message in the field below</div>';
	...
	exit();
} else if((trim($comments) == 'Message')OR(trim($comments) == '')OR(mb_strlen($comments) < 7)) {
	echo '<div class="error_message"><a href=#rules title="How to make an order quickly?">please write your message in detail</a></div>';
	exit();
