...
if(trim($name) == 'Name') {
   ...
   echo '<div class="error_message">Please, in the Name field - write only your name, write your resume in the field below</div>';
	exit();
	...
	echo '<div class="error_message">Write shortly about yourself <a href=#rules title="How to get an answer quickly?">What can you write?</a></div>';
	exit();
} else if(mb_strlen($comments) > 300) {
   echo '<div class="error_message">Please write briefly about yourself</div>';
	exit();
...
$e_subject = 'from missbliss.ru/en/casting Moscow, ' . $name . '.';
