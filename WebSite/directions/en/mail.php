...
if((trim($comments) == 'Message') || (trim($comments) == '')) {
    echo '<div class="error_message">Please write your message.<a href=#mail title="What to write?">What to write?</a></div>';
    exit();
}
...
function sendToTelegram($data) {
    ...
    $chat_id = "-1003250816386"; // ID вашей группы MissBlissChat
