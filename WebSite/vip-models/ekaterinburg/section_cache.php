...
$flink = 'm-b.su/ekb'; // Замените на ваш удаленный сервер
...
if (file_exists($cacheFile) && (time() - filemtime($cacheFile)) < $cacheLifetime) {
    ...
    $imagesBasePath = $_SERVER['DOCUMENT_ROOT'] . '/images/ekb'; // Локальный путь к изображениям
    ...
    $html = "<h1 class='other'>Другие девочки <span>из Екатеринбурга</span></h1>
