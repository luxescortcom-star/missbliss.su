...
$flink = 'm-b.su/'.$city.''; // Замените на ваш удаленный сервер
...
if (file_exists($cacheFile) && (time() - filemtime($cacheFile)) < $cacheLifetime) {
    ...
    $imagesBasePath = $_SERVER['DOCUMENT_ROOT'] . '/images/'.$city.''; // Локальный путь к изображениям
    ...
    function findImage($basePath, $picsFolio, $name) {
        $imageFormats = ['avif', 'jp2', 'jpg', 'webp'];
        $imagePath = '';
                ...
                if (!empty($variables)) {
                    ...
                    if ($imageName) {
                        ...
                        $blurClass = $variables['blur'] ? 'blur' : '';
						          ...
						          // Получаем имя файла без расширения для использования в ссылке
    ...
    $html = "<h1 class='other'>Другие девочки <span>из Москвы</span></h1>
