...
$height = '160 см';
$weight = '48 кг';
$dataType = 'молодая модель би busty брюнетка мск';


$en_title='Yana, a petite, bright brunette with a beautiful sexy figure';
$title='Яна, миниатюрная яркая брюнетка с красивой сексуальной фигуркой';
...
include_once (__ROOT__. '/includes/profiles/moscow/attractive/yana.php');
...
<div class="accCon"><h4>Обо мне...</h4><p>Молодая и игривая, люблю проводить время с приятными людьми в непринуждённой обстановке</p><h4>Оценка агентства...</h4><p>'.$name.', миниатюрная яркая брюнетка с красивой сексуальной фигуркой. Очень темпераментная и комфортная спутница.</p><br><h4><a href="<?=$feedback ?>"><i class="fa fa-certificate" aria-hidden="true"></i> Оставить отзыв</a> <i class="far fa-thumbs-up"></i></h4></div>
