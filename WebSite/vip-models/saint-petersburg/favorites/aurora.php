...
$dataType = 'взрослая фаворитка busty брюнетка спб';
...
$title='Завораживающая смесь кокетства и сексуальности, легкая в общении веселая интеллигентная девушка. Элитный эскорт в Санкт-Петербурге';
$description = 'завораживающая смесь кокетства и сексуальности, легкая в общении веселая интеллигентная девушка. Красивая, уникальная с роскошной фигурой юная Леди. Умеет быть любимой.';
$keywords = 'брюнетка эскортница, эскорт спб, аврора эскорт спб';
...
$canonical = 'https://missbliss.spb.ru/favorites/aurora/';
?>
<!DOCTYPE html>
...
<?php
include_once (__ROOT__.'/includes/workers/slider_functions.php');
...
<div class="accCon"><p>Город:<span><?=$home ?></span></p><p>Выезды<span>Есть шенген</span></p><p>Возраст:<span><?php echo $ageData['age']; ?></span></p><p> Рост:<span><?=$height ?></span></p><p>Вес:<span><?=$weight ?></span></p><p> Объемы:<span>90-64-90 cm</span></p><p>Размер груди<span>2 (80С), натуральная </span></p><p>Размер одежды<span>M-S</span></p><p>Цвет глаз<span>Голубой</span></p><p>Цвет волос<span>Золотисто-Русый</span></p><p> Ориентация<span>Бисексуальна</span></p><p>Отношение к курению<span>Не курю</span></p><p>Общение<span>Русский-Английский</span></p><p> Знак зодиака<span><?php echo $ageData['zodiac']; ?></span></p></div>
...
<?php include_once (__ROOT__.'/includes/favorites-rates.php'); ?>
<div class="footer">
<?=$invite ?>
</div> </div>
