...
$flink = 'm-b.su/krasnodar'; // Замените на ваш удаленный сервер
...
if (file_exists($cacheFile) && (time() - filemtime($cacheFile)) < $cacheLifetime) {
    ...
    $imagesBasePath = $_SERVER['DOCUMENT_ROOT'] . '/images/krasnodar'; // Локальный путь к изображениям
    ...
    $html = "<h1 class='other'>Другие девочки<span> из Крснодара</span></h1>
