...
if(trim($name) == 'Имя') {
   ...
   echo '<div class="error_message">Пожалуйста, в поле Имя - пишите только имя, ваше резюме пишите в поле ниже</div>';
	...
	echo '<div class="error_message">Напишите коротко о себе <a href=#mail title="Как быстро получить ответ?">Что можно написать?</a></div>';
	exit();
} else if(mb_strlen($comments) > 300) {
   echo '<div class="error_message">Пожалуйста, напишите о себе коротко</div>';
	exit();
...
$e_subject = 'missbliss.ru/casting Москва' . $name . '.';
...
$e_body = "Новенькая модель в Москве: $name" . PHP_EOL . PHP_EOL;
