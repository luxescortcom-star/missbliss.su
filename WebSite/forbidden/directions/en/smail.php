...
if(trim($name) == 'Name') {
	...
	echo '<div class="error_message">Write your message please.<a href=#rules title="I watn invite i beautifull Escort"> What is better to write?</a></div>';
	exit();
...
die('<div class="error_message">SpamFilter - SPAM and Links are not allowed  <a href=#spam title="Email Processing Policy">Detailed...</a></div>'); //убиваем скрипт и выводим сообщение
}
...
$e_subject='Guest in St Petersburg  from missbliss.ru/en/contact/ , St-Petersburg' . $name . '.';
