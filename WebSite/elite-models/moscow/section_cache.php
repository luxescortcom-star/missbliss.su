...
$flink = 'm-b.su/msk'; // Замените на ваш удаленный сервер
...
if (file_exists($cacheFile) && (time() - filemtime($cacheFile)) < $cacheLifetime) {
    ...
    $imagesBasePath = $_SERVER['DOCUMENT_ROOT'] . '/images/msk'; // Локальный путь к изображениям
    ...
    $html = "<h1 class='other'>Other girls <span>from Moscow</span></h1>
