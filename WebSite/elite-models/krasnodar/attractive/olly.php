...
$title='Olya 🤩adult worthy Lady. Elite escort in Krasnodar.';
$ru_title='Оля 🤩взрослая достойная Леди. Элитный эскорт в Краснодаре.';
$description = 'A cheerful and bright companion for a worthy gentleman. A romantic, open, cheerful girl without complexes. Ready for healthy adventures and erotic adventures.';
$keywords = 'Krasnodar escort, escort girl Krasnodar, escort Olya Krasnodar';
...
$uri = substr(substr($_SERVER['REQUEST_URI'], 9), 14);
