...
$en_title='Elite Escort Models in Russia | MissBliss Agency Gallery';
$title='Элитные эскортницы России | Галерея анкет агентства МиссБлисс';
$description = 'Агентство МиссБлисс – лучшие эскортницы Москвы, Санкт-Петербурга, Краснодара и Екатеринбурга. Галерея анкет элитных спутниц для мероприятий и отдыха. Конфиденциальность и премиум-сервис.';
$keywords = 'эскорт агентство, элитные эскортницы, эскорт модели, индивидуалки, премиум эскорт, спутницы, эскорт Москва, эскорт СПб, эскорт Краснодар, эскорт Екатеринбург';
$canonical = 'https://missbliss.ru/escorts/';
$fxt = 'jpg';
...
<li class="current all"><!--noindex--><a href="#модели" rel="nofollow">Все модели</a><!--/noindex-->
...
<li class="краснодар"><!--noindex--><a href="#краснодар" rel="nofollow">Краснодар</a><!--/noindex-->
<li class="екб"><!--noindex--><a href="#екб" rel="nofollow">Екатеринбург</a><!--/noindex-->
...
<div id="projects3">
<?php include_once ('gallery_bd.php'); ?>
</div>
</div>
</div>
<div id="footer">
